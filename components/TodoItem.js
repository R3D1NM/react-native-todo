...
const TodoItem = (props) => {
    ...
    <View style={styles.itemContainer}>
        <Pressable style={styles.itemCheckBox} hitSlop={10} onPress={()=>dispatch(updateTodo(props.id))}>
            {props.state === 'todo'?
            <CheckboxUnchecked/>
            :
        ...
        <Pressable style={[styles.deleteButton, props.state==="done"?styles.deleteButtonDone:'']}
        hitSlop={10}
